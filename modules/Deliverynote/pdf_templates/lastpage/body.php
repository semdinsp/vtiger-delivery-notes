...
/* ************* Begin Totals ************************** */
// scott $totalBlock=array("59","135");
//scott$names=array($app_strings["Subtotal"],$app_strings["Tax"],$app_strings["Adjustment"],$app_strings["Total"]);
// scott $totals=array($price_subtotal,$price_salestax,$price_adjustment,$price_total);
//sctt $pdf->addTotalsRec($names,$totals,$totalBlock);
/* ************* End Totals *************************** */
...
$pdf->addDescBlock("Company Stamp", $app_strings["DOStamp"], $descBlock);


// scott $termBlock=array("107","160","53", $num);
